...
export declare class CodemirrorComponent implements AfterViewInit, OnDestroy, ControlValueAccessor, DoCheck {
    ...
    /** Implemented as part of ControlValueAccessor. */
    private onTouched;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<CodemirrorComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<CodemirrorComponent, "ngx-codemirror", never, { "className": "className"; "name": "name"; "autoFocus": "autoFocus"; "preserveScrollPosition": "preserveScrollPosition"; "options": "options"; }, { "cursorActivity": "cursorActivity"; "focusChange": "focusChange"; "scroll": "scroll"; "drop": "drop"; }, never, never>;
}
